if(Rmodules && typeof Rmodules.define === 'function') { Rmodules.define('R.api', '1.10.1', ['R^1'], [], function(R, undefined) {
/*
 R.api-1.10.1.js
 Copyright (c) 2019 Rakuten.Inc
 Date: 2019-01-28 17:18:29
*/
...
a.Item.prototype.getShopUrl=function(){var a=this._data.shopUrl;return a?"//www.rakuten.co.jp/"+a+"/":b},a.Item.prototype.getShopLogoUrl=function(a,c,d,e){var f=this._data.shopUrl;if(!f)return b;var g="//tshop.r10s.jp/"+f+"/logo/logo"+a+(c?"n.jpg":".jpg")+(d&&e?"?fitin="+String(d)+":"+String(e):"");return g},a.Item.prototype.getItemId=function(){return this._data.itemId},a.Item.prototype.getItemUrl=function(){return this._data.itemUrlFull},a.Item.prototype.getItemName=function(){return this._data.itemName;
...
},a.Item.prototype.isTimeSale=function(){return this._data.isTimeSale},a.Item.prototype.isPurchasable=function(){return this._data.isPurchasable},a.Item.prototype.getCatalogImages=function(){return this._data.catalogImages},a.Item.prototype.getItemDiscountType=function(){return this._data.discountType},a.Item.prototype.getItemDiscountValue=function(){return this._data.discountValue},a.Item.prototype.getCacheKey=a.Item.prototype.getItemId}(R),function(a,b){"use strict";function c(b){var c="thumbnail.image.rakuten.co.jp/@0_mall/",f="thumbnail.image.rakuten.co.jp/@0_gold/",g="tshop.r10s.jp/",h="tshop.r10s.jp/gold/";
if(b._processed)return b;var i=a.coalesce(b.ichibaItemImg,b.roomItemImg);return i&&(i=i.replace(e,"").replace(d,""),"?"===i.charAt(i.length-1)&&(i=i.substring(0,i.length-1)),-1!==i.indexOf(c)?i=i.replace(c,g):-1!==i.indexOf(f)&&(i=i.replace(f,h))),{_processed:!0,itemId:parseInt(b.itemId,10),itemCode:b.itemCode,itemName:b.itemName,itemPrice:parseInt(b.itemPrice,10),itemImageUrl:i,itemUrl:b.itemUrl,shopId:parseInt(b.shopId,10),shopCode:b.shopCode,shopName:b.shopName,ownerUsername:b.userName,ownerImageUrl:b.userImg,
...
g.endDate=new a.Date(g.endDate),g.currentDate=new a.Date(g.currentDate),g.ignoreDates||g.currentDate.isBetween(g.startDate,g.endDate)?(e=a.extendApiSettings({url:d+"shop_counter.php",data:{buy_type:"s",s:g.startDate.getCalendarFormat(),e:g.endDate.getCalendarFormat()}},g),a.requestData(e).fail(f.reject).done(function(b){b&&"success"===b.status?f.resolve(new a.api.kaimawari.ResponseData(b.count,b.last_date)):f.reject(b)}),f.promise()):(f.resolve(null),f.promise())}}(R),function(a,b){"use strict";function c(b){
var c,d,e,f,g=[],h={};if(b&&(f=b.status&&b.status.toLowerCase(),"success"===f||"notfound"===f)){for(h.tracking_tag=b.tracking_tag||!1,h.group_id=b.group_id||!1,h.lid=b.lid||!1,h.title=b.title||!1,h.widget_type=b.widget_type||!1,c=0,d=b.item.length;d>c;c++)e=new a.Item(b.item[c]),g.push(e);return{items:g,extraData:h}}return{error:!0,data:b}}function d(a,b){var d,e,f,g=[];for(e=0,f=a.length;f>e;e++)d=c(a[e]),d.error?g.push({error:d.data}):g.push(d);return g}var e=a.$,f="//grp03.api.rp.rakuten.co.jp/geap/v1/ichiba/rcmd/recommend_ichiba.json";
a.api.itemRecommendation={ServiceId:{BROWSING_HISTORY:"00-00-000-002",PC:"00-00-000-210",SP:"00-00-000-212",PC_TOP:"00-00-000-230",SP_TOP:"00-00-000-234",STEP0_PC:"00-00-000-032",STEP0_SP:"00-00-000-036",PC_EVENT:"00-00-000-232",SP_EVENT:"00-00-000-236",BUY_AGAIN_PC_EVENT:"00-00-000-062",BUY_AGAIN_SP_EVENT:"00-00-000-060"},Encoding:{UTF_8:"utf-8",EUC_JP:"euc-jp"}},a.api.itemRecommendation.loadUserBasedRecommendedItems=function(b){var g,h,i=e.Deferred(),j=e.extend({mock_id:"USER_BASED_RECOMMEND",retry:0,
timeout:a.isMobile?9e3:3e3,cache:!0},b);if(!j.sid)throw"required options.sid not set";var k=a.isArray(j.sid)?a.addSerializedArrayToUrl(f,"sid",j.sid):a.addUrlParams(f,{sid:j.sid});return g=a.extendApiSettings({url:k,data:{}},j),j.encoding&&(g.data.encoding=j.encoding),j.genre&&(g.data.gid=j.genre),j.itemId&&(h=/^([^\/]+)\/([^\/]+)$/.exec(j.itemId),g.data.item_id=h?h[1]+"_"+h[2]:j.itemId),j.lid&&(g.data.lid=j.lid),j.filterQuery&&(g.data.url=a.addSerializedArrayToUrl(g.url,"fq",j.filterQuery.split("&"))),
j.groupBy&&(g.data.groupby=j.groupBy),a.requestData(g).fail(i.reject).done(function(a){var b;e.isArray(a)?i.resolve(d(a)):(b=c(a),b.error?i.reject(b.data):i.resolve(b.items,b.extraData))}),i.promise()}}(R),function(a,b){"use strict";var c=a.$,d="/com/js/d/deal_ranking/data/DealRanking.json";a.api.deal={},a.api.deal.loadRankingItems=function(e){var f,g=c.Deferred(),h=c.extend({mock_id:"DEAL_RANKING",retry:0,cache:!0},e);return f=a.extendApiSettings({url:d,data:{sid:h.sid},dataType:"json"},h),a.requestData(f).fail(g.reject).done(function(c,d,e){
var f,h,i,j,k=[];if(c&&c.DealRanking){for(f=0,h=c.DealRanking.length;h>f;f++)i=new a.Item(c.DealRanking[f]),k.push(i);j=e&&e.getResponseHeader("last-modified"),j=j?new a.Date(j):b,g.resolve(k,j)}else g.reject(c)}),g.promise()}}(R),function(a,b){"use strict";var c=a.$,d="https://api.premium.rakuten.co.jp/v1.0/isMember",e={};return e.ServiceId={ICHIBA_TOP:2,BASKET:2,PORTAL:3,PORTA_R_DR:4},e.ResponseData=function(a){this._data={status:a.status,remainingRewardCount:a.remainingRewardCount}},e.ResponseData.prototype.isMember=function(){
return 200===this._data.status&&this._data.remainingRewardCount!=b},e.ResponseData.prototype.getRemainingRewardCount=function(){return this._data.remainingRewardCount},e.getMemberDetails=function(b){var e,f,g=c.Deferred();if(!b.sid)throw"options.sid required";return a.user.isLogged()?(f=c.extend({mock_id:"PREMIUM_MEMBER",retry:0,cache:!0},b),e=a.extendApiSettings({url:d,data:{serviceId:f.sid}},f),a.requestData(e).fail(g.reject).done(function(b){!b||200!==b.status&&404!==b.status?g.reject(b):g.resolve(new a.api.premiumMember.ResponseData(b));
}),g.promise()):(g.resolve(new a.api.premiumMember.ResponseData({status:404,remainingRewardCount:0})),g.promise())},a.api.premiumMember=e,a.api.premiumMember}(R),function(a,b){"use strict";var c=a.$,d="//app.rakuten.co.jp/engine/zapi/Room/CollectRecommendFeedWithRz/20171122";a.api.room={DEFAULT_FORMAT:"json"},a.api.room.loadRecommendedItems=function(b){var e,f=c.Deferred(),g=c.extend({},b),h={format:a.api.room.DEFAULT_FORMAT};return b.genreId&&(h.genre_id=b.genreId),b.shopId&&(h.shop_id=b.shopId),
e=a.extendApiSettings({url:d,data:h},g),b.mockUrl&&b.dataType&&(e.dataType=b.dataType),a.requestData(e).fail(function(a){f.reject(a)}).done(function(b){if(b&&b.items){for(var c={items:[]},d=0,e=b.items.length;e>d;d++)c.items.push(new a.RoomPost(b.items[d]));b.tracking_tag&&(c.tracking={rtg:b.tracking_tag}),f.resolve(c)}else f.reject(b)}),f.promise()}}(R),function(a,b){"use strict";function c(a){return a=a.toLowerCase(),function(b){return b.id===a}}var d=a.$,e="https://ichiba-p-rate.api.rakuten.co.jp/spu/jsonp",f={},g={};
a.api.spu={ServiceId:a.api.ServiceIds,Source:{PC:"pc",SP:"sp",APP:"app"},ViewType:{DEFAULT:"default",TOP:"top",CATEGORY:"category",EVENT:"event",ITEM:"item",SHOP:"shop",SEARCH:"search",STEP0:"step0",STEP4:"step4",MEMBER_INFO:"memberinfo"},UserRank:a.enums.UserRank,Encoding:{UTF_8:"UTF-8",EUC_JP:"EUC-JP"}},a.api.spu.ResponseData=function(b){var c,d,e;if(this.totalRate=0,this.userRank=a.enums.UserRank.DEFAULT,this.sections=[],b&&(this.totalRate=parseFloat(b.totalRate),this.userRank=parseInt(b.userRank,10)),
b.sections)for(c=0,d=b.sections.length;d>c;c++)e=new a.api.spu.SpuSection(b.sections[c]),e.parent=this,this.addSection(e,null,!0)},a.api.spu.ResponseData.prototype.addSection=function(a,b,c){var d,e,f=this.sections.length;if(a.parent=this,this.sections.splice(null==b?1/0:b,0,a),!c)for(e=0,f=a.services.length;f>e;e++)d=a.services[e],this.totalRate+=d.rate},a.api.spu.ResponseData.prototype.getSection=function(d){var e=a.find(this.sections,c(d));return-1===e?b:this.sections[e]},a.api.spu.ResponseData.prototype.removeSection=function(b){
var d,e=a.find(this.sections,c(b));-1!==e&&(d=this.sections[e],this.totalRate-=d.totalRate,this.sections.splice(e,1))},a.api.spu.ResponseData.prototype.getService=function(a){var c,d,e;for(c=0,d=this.sections.length;d>c;c++)if(e=this.sections[c].getService(a))return e;return b},a.api.spu.ResponseData.prototype.removeService=function(a){var b,c;for(b=0,c=this.sections.length;c>b;b++)this.sections[b].removeService(a)},a.api.spu.ResponseData.prototype.getAllServices=function(a){var b,c,d,e,f,g=this.sections.length,h=[];
for(b=0;g>b;b++)for(c=this.sections[b],e=c.services.length,d=0;e>d;d++)f=c.services[d],(f.isQualified||a)&&h.push({section:c,service:f});return h},a.api.spu.ResponseData.prototype.getUserRankString=function(b){b=b||this.userRank;var c=a.find(a.api.spu.UserRank,function(a){return a===b});return-1!==c?c.toLowerCase():""},a.api.spu.SpuSection=function(b){var c,d,e,g=b.id.toLowerCase();for(f[g]=b.id,this.id=g,this.name=b.name,this.totalRate=parseFloat(b.totalRate),this.services=[],c=0,d=b.services.length;d>c;c++)e=new a.api.spu.SpuSectionService(b.services[c]),
this.addService(e,null,!0)},a.api.spu.SpuSection.prototype.getService=function(d){var e=a.find(this.services,c(d));return-1===e?b:this.services[e]},a.api.spu.SpuSection.prototype.addService=function(a,b,c){a.parent=this,this.services.splice(null==b?1/0:b,0,a),!c&&a.isQualified&&(this.totalRate+=a.rate,this.parent&&(this.parent.totalRate+=a.rate))},a.api.spu.SpuSection.prototype.removeService=function(b){for(var d,e=a.find(this.services,c(b));-1!==e;)d=this.services[e],d.isQualified&&(this.totalRate-=d.rate,
this.parent&&(this.parent.totalRate-=d.rate)),this.services.splice(e,1),e=a.find(this.services,c(b))},a.api.spu.SpuSectionService=function(a){var b=a.id.toLowerCase();g[b]=a.id,this.id=b,this.name=a.name,this.rate=parseFloat(a.rate),this.isQualified=a.qualified,this.link=a.link},a.api.spu.loadSpu=function(b){var c,f=d.Deferred(),g=d.extend({mock_id:"SPU",encoding:a.api.spu.EUC_JP,retry:3,cache:!0},b);if(!g.sid)throw"required options.sid not set";if(!g.source)throw"required options.source not set";
if(!g.viewType)throw"required options.viewType not set";return c=a.extendApiSettings({url:e,data:{source:g.source,viewType:g.viewType,acc:g.sid.acc,aid:g.sid.aid,enc:g.encoding}},b),g.userRank&&(c.data.userRank=g.userRank),g.itemId&&(c.data.itemId=g.itemId),g.shopId&&(c.data.shopId=g.shopId),a.requestData(c).fail(f.reject).done(function(b){return b?void f.resolve(new a.api.spu.ResponseData(b)):void f.reject()}),f.promise()},a.api.spu.getOriginalSectionId=function(a){return f[a.toLowerCase()]},a.api.spu.getOriginalServiceId=function(a){
return g[a.toLowerCase()]}}(R),function(a,b){"use strict";var c=a.$,d="https://api.ranking.rakuten.co.jp/deliver/api/deliver/";a.api.itemRanking={Encoding:{UTF_8:1,EUC_JP:0},QueryType:{NORMAL_RANKING:1,COUPON:2,NO1_OF_EACH_GENRE:3,GENRE_TREE:5,RANKED_IN:6,BOOKS_RANKING:7,TAG_RANKING:8,TAG_TREE:9,KOBO:10,SUPER_SALE:11,RANKED_IN_ITEM_SEARCH:12,RANKING_GENRE_SEARCH:13,BOOKS_RANKING_GENRE:15},TargetPeriod:{DAILY:1,WEEKLY:2,MONTHLY:3,HALF_YEAR:4,YEARLY:5,REAL_TIME:6,EVENT:7,ASURAKU:8},SearchType:{PRODUCT:0,
CATALOG:1},SalesType:{GENERAL:0,NORMAL_PURCHASE:1,MULTIPLE_PURCHASE:2},CalculationType:{AVERAGE:1,HIGH:2,QUANTITY:3,AMOUNT:4,PIECES:5},MobileFlag:{OFF:0,ON:1}},a.api.itemRanking.ResponseData=function(b){this.getItems=function(){var c,d,e=b.items,f=e.length,g=[];for(d=0;f>d;d++)c=new a.Item(e[d]),g.push(c);return g},this.getQuery=function(){return b.query},this.getRankingId=function(){return b.rankingid}},a.api.itemRanking.loadRankingItems=function(b){var e,f=c.Deferred(),g=c.extend({mockId:"RANKING",
retry:3,cache:!0,queryType:a.api.itemRanking.QueryType.NORMAL_RANKING,areaCode:"00"},b);if(!g.genreId)throw"Required options.genreId is not set.";return e=a.extendApiSettings({url:d,data:{qt:g.queryType,pr:g.areaCode,gid:g.genreId,enc:g.encoding,event_rnk_id:g.eventRankingId,eid:g.eventId,du:g.targetPeriod,offset:g.offset,st:g.searchType,sl:g.salesType,rt:g.calculationType,mb:g.mobileFlag,len:g.itemNameLength,slen:g.shopNameLength}},b),a.requestData(e).fail(f.reject).done(function(b){return b?void("0"===b.code?f.resolve(new a.api.itemRanking.ResponseData(b)):f.reject(b)):void f.reject();
}),f.promise()}}(R);
//# sourceMappingURL=R.api-1.10.1.min.js.map
return R.api; });}