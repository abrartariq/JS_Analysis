 ...
 */
/*! @generated */
/* Prebid.js v1.18.0 with DA patches (see ssh://git@phrac-git.deviantart.net/diffusion/PREBID/web-prebid.git) */
...
var _userSync = __webpack_require__(16);
...
var _videoCache = __webpack_require__(193);
...
var _secureCreatives = __webpack_require__(535);
...
var _debugging = __webpack_require__(536);
...
pbjs.version = 'v1.18.0';
utils.logInfo('Prebid.js v1.18.0 loaded');
...
var _isArray = __webpack_require__(272);

var _isArray2 = _interopRequireDefault(_isArray);

var _isInteger = __webpack_require__(274);
...
var INTEGRATION = 'pbjs_lite_v1.18.0';
...
var spec = exports.spec = {
  ...
  buildRequests: function buildRequests(bidRequests, bidderRequest) {
    ...
    var requests = [];
    var videoRequests = bidRequests.filter(hasVideoMediaType).map(function (bidRequest) {
    ...
    if (_config.config.getConfig('rubicon.singleRequest') !== true) {
      ...
      requests = videoRequests.concat(bidRequests.filter(function (bidRequest) {
        return !hasVideoMediaType(bidRequest);
  ...
  interpretResponse: function interpretResponse(responseObj, _ref3) {
    ...
    if ((typeof bidRequest === 'undefined' ? 'undefined' : _typeof(bidRequest)) === 'object' && !Array.isArray(bidRequest) && hasVideoMediaType(bidRequest) && (typeof ads === 'undefined' ? 'undefined' : _typeof(ads)) === 'object') {
...
var _creative = function _creative(mediaType) {
  return function (sbi_dc, sbi_aid) {
    ...
    var src = 'https://' + sbi_dc + 'apex.go.sonobi.com/sbi.js?aid=' + sbi_aid + '&as=null' + '&ref=' + (0, _utils.getTopWindowLocation)().href;
    return '<script type="text/javascript" src="' + src + '"></script>';
  };
};

function _videoCreative(sbi_dc, sbi_aid) {
  return 'https://' + sbi_dc + 'apex.go.sonobi.com/vast.xml?vid=' + sbi_aid + '&ref=' + (0, _utils.getTopWindowLocation)().href;
}
...
var tripleliftAdapterSpec = exports.tripleliftAdapterSpec = {
  ...
  buildRequests: function buildRequests(bidRequests, bidderRequest) {
    ...
    tlCall = utils.tryAppendQueryString(tlCall, 'v', '1.18.0');
