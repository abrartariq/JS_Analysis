...
n=n.replace(/%00/g,"");
if(b&&SfdcWwwBase.gdpr.isCookieActive(u)){m.c_wr(u,o,0)
}if(a){l=n;
...
a.j(c,"load",a.N)
}window.MutationObserver=window.MutationObserver||function(n){function q(p){this.i=[];
this.m=p
}function m(p){(function w(){var x=p.takeRecords();
x.length&&p.m(x,p);
p.h=setTimeout(w,q._period)
})()
}function d(w){var p={type:null,target:null,addedNodes:[],removedNodes:[],previousSibling:null,nextSibling:null,attributeName:null,attributeNamespace:null,oldValue:null},x;
for(x in w){p[x]!==n&&w[x]!==n&&(p[x]=w[x])
}return p
}function l(w,p){var x=b(w,p);
return function(z){var y=z.length,A;
p.a&&3===w.nodeType&&w.nodeValue!==x.a&&z.push(new d({type:"characterData",target:w,oldValue:x.a}));
p.b&&x.b&&f(z,w,x.b,p.f);
if(p.c||p.g){A=k(z,w,x,p)
}if(A||z.length!==y){x=b(w,p)
}}
}function j(w,p){return p.value
}function h(w,p){return"style"!==p.name?p.value:w.style.cssText
}function f(E,C,B,A){for(var z={},p=C.attributes,w,y,D=p.length;
D--;
){w=p[D],y=w.name,A&&A[y]===n||(a(C,w)!==B[y]&&E.push(d({type:"attributes",target:C,attributeName:y,oldValue:B[y],attributeNamespace:w.namespaceURI})),z[y]=!0)
}for(y in B){z[y]||E.push(d({target:C,type:"attributes",attributeName:y,oldValue:B[y]}))
}}function k(w,p,B,z){function y(K,I,G,D,J){var F=K.length-1;
J=-~((F-J)/2);
for(var E,C,H;
H=K.pop();
){E=G[H.j],C=D[H.l],z.c&&J&&Math.abs(H.j-H.l)>=F&&(w.push(d({type:"childList",target:I,addedNodes:[E],removedNodes:[E],nextSibling:E.nextSibling,previousSibling:E.previousSibling})),J--),z.b&&C.b&&f(w,E,C.b,z.f),z.a&&3===E.nodeType&&E.nodeValue!==C.a&&w.push(d({type:"characterData",target:E,oldValue:C.a})),z.g&&A(E,C)
}}function A(L,K){for(var H=L.childNodes,D=K.c,M=H.length,N=D?D.length:0,G,F,I,E,P,J=0,O=0,C=0;
O<M||C<N;
){E=H[O],P=(I=D[C])&&I.node,E===P?(z.b&&I.b&&f(w,E,I.b,z.f),z.a&&I.a!==n&&E.nodeValue!==I.a&&w.push(d({type:"characterData",target:E,oldValue:I.a})),F&&y(F,L,H,D,J),z.g&&(E.childNodes.length||I.c&&I.c.length)&&A(E,I),O++,C++):(x=!0,G||(G={},F=[]),E&&(G[I=u(E)]||(G[I]=!0,-1===(I=t(D,E,C,"node"))?z.c&&(w.push(d({type:"childList",target:L,addedNodes:[E],nextSibling:E.nextSibling,previousSibling:E.previousSibling})),J++):F.push({j:O,l:I})),O++),P&&P!==H[O]&&(G[I=u(P)]||(G[I]=!0,-1===(I=t(H,P,O))?z.c&&(w.push(d({type:"childList",target:K.node,removedNodes:[P],nextSibling:D[C+1],previousSibling:D[C-1]})),J--):F.push({j:I,l:C})),C++))
}F&&y(F,L,H,D,J)
}var x;
A(p,B);
return x
}function b(w,p){var y=!0;
return function x(z){var A={node:z};
!p.a||3!==z.nodeType&&8!==z.nodeType?(p.b&&y&&1===z.nodeType&&(A.b=r(z.attributes,function(C,B){if(!p.f||p.f[B.name]){C[B.name]=a(z,B)
}return C
})),y&&(p.c||p.a||p.b&&p.g)&&(A.c=g(z.childNodes,x)),y=p.g):A.a=z.nodeValue;
return A
}(w)
}function u(w){try{return w.id||(w.mo_id=w.mo_id||o++)
}catch(p){try{return w.nodeValue
}catch(x){return o++
}}}function g(w,p){for(var y=[],x=0;
x<w.length;
x++){y[x]=p(w[x],x,w)
}return y
}function r(w,p){for(var y={},x=0;
x<w.length;
x++){y=p(y,w[x],x,w)
}return y
}function t(w,p,y,x){for(;
y<w.length;
y++){if((x?w[y][x]:w[y])===p){return y
}}return -1
}q._period=30;
q.prototype={observe:function(w,p){for(var z={b:!!(p.attributes||p.attributeFilter||p.attributeOldValue),c:!!p.childList,g:!!p.subtree,a:!(!p.characterData&&!p.characterDataOldValue)},y=this.i,x=0;
x<y.length;
x++){y[x].s===w&&y.splice(x,1)
}p.attributeFilter&&(z.f=r(p.attributeFilter,function(B,A){B[A]=!0;
return B
}));
y.push({s:w,o:l(w,z)});
this.h||m(this)
},takeRecords:function(){for(var w=[],p=this.i,x=0;
x<p.length;
x++){p[x].o(w)
}return w
...
c.style.top=0;
var a=(c="null"!=c.attributes.style.value)?j:h,o=1;
return q
}(void 0);
...
if(d){digitalData.util.writeCookie("lastOffer",d+":view");
digitalData.page.offerid=digitalData.util.getValueOnce(d,"v28");
...
digitalData.util.writeCookie("c30",digitalData.page.offerid)
}}if(digitalData.page.offerid&&!Page.isFormKickback()){digitalData.util.addBehavior("formview")
}}else{if(Page.isConfirmation()&&!Page.isFormPreSyncConfirmPage(digitalData.page.pagename)){digitalData.util.addBehavior("formconfirmationview");
if(Page.isSkipFormRedirect()){var h=Util.convert15To18(Util.getParam("d")?Util.getParam("d"):Util.getParam("DriverCampaignId"));
...
if(Page.isSkipFormRedirect()){digitalData.util.addBehavior("autoformcomplete")
}else{if(!(digitalData.util.readCookie("v28")||digitalData.util.readCookie("c30"))){digitalData.page.offerid="[NO OFFER ID]"
}else{digitalData.page.offerid=digitalData.util.readCookie("c30")
}digitalData.util.addBehavior("formcompletesubmitbuttonclick");
...
digitalData.page.searchterm=digitalData.util.getValueOnce(digitalData.page.searchterm,"v12");
...
}if(digitalData.util.readCookie("v32")){digitalData.page.moduletracking=digitalData.util.readCookie("v32");
digitalData.util.deleteCookie("v32");
...
}else{if(digitalData.page.moduletracking.indexOf("|footer")>-1){j="Bottom"
}}}}if(j){var b=Page.getNameNoLocale();
b=b.replace(Page.getServer()+":","");
digitalData.page.toporleftnav=j+"|"+b;
if(j==="Bottom"){digitalData.util.addBehavior("bottomnavigationclicks")
}else{digitalData.util.addBehavior("topnavigationclicks")
...
return function(h,k){if(g){var j=new g(function(l,m){if(l[0].addedNodes.length||l[0].removedNodes.length){k(l)
}});
...
Page.clientContextCTAs=[];
Page.noclosure_ctas=[];
$(c).each(function(f){b(document.getElementById(c[f]),function(k){var w=offerid=type=_location="";
var o=[];
var l,p,m;
var n=k[0];
for(var r=0;
r<k.length;
r++){if(k[r].addedNodes&&k[r].addedNodes.length>0){$anchors=$(k[r].addedNodes[0]).html()===null?$([]):$(k[r].addedNodes[0]).find("a");
$anchors.each(function(){if(Page.isValidDynamicComponentLink(this)){m=Util.getParam("d",Util.getHref(this)).length==15?Util.convert15To18(Util.getParam("d",Util.getHref(this))):Util.getParam("d",Util.getHref(this));
if($.inArray(m,Page.clientContextCTAs)===-1){Page.clientContextCTAs.push(m)
}}});
d+=1
}}if(d===c.length){(function(){if(typeof window.CustomEvent==="function"){return false
}function x(z,A){A=A||{bubbles:false,cancelable:false,detail:undefined};
var y=document.createEvent("CustomEvent");
y.initCustomEvent(z,A.bubbles,A.cancelable,A.detail);
return y
}x.prototype=window.Event.prototype;
window.CustomEvent=x
})();
var h=new CustomEvent("targetedContentLoaded",{detail:{targetDivs:c}});
document.dispatchEvent(h);
var j=$("div[data-campaign-url]");
var g=[];
j.each(function(x,z){var y=$(z).data("campaignUrl");
y=y.replace("|content|campaigns|","").replace("|_jcr_content|par","");
g.push(y)
});
var u=g.join(",");
if(window.s_tnt){s.tnt=s.deDupe(s.trackTNT(),",");
s.linkTrackVars=s.apl(s.linkTrackVars,"tnt",",",2)
}var t=Page.clientContextCTAs;
var q=!(digitalData.user[0].profile[0]&&digitalData.user[0].profile[0].db&&digitalData.user[0].profile[0].db.city&&digitalData.user[0].profile[0].db.state)?"":digitalData.user[0].profile[0].db.city+"|"+digitalData.user[0].profile[0].db.state;
...
}digitalData.util.trackActivity(digitalData.page.pagename+"|dynamic_component_tracking",{events:["event19"],properties:{eVar82:q,eVar52:digitalData.user[0].profile[0].targetingcompanyname,eVar63:digitalData.user[0].profile[0].targetingaudience,eVar41:digitalData.user[0].profile[0].targetingcompanyindustry,list1:u,products:t}});
trackTrailheadLinks()
}})
});
if(c.length===0){trackTrailheadLinks()
}};
digitalData.util.trackVidyardLoad=function(){digitalData.util.addBehavior("video_load")
};
...
digitalData.util.addPageData("videoduration",typeof d==="number"?d.toString():"");
...
if(Page.hasInternalReferrer()){Page.prevpageanalyticsurl=digitalData.util.readCookie("prevpageanalyticsurl")
}digitalData.util.deleteCookie("prevpageanalyticsurl");
var b=Util.getMeta("analytics_url");
if(b){$("a").on("click",function(){digitalData.util.writeCookie("prevpageanalyticsurl",b)
})
}else{$("a").on("click",function(){digitalData.util.writeCookie("prevpageanalyticsurl",curName)
})
...
digitalData.page.emailid=digitalData.util.getValueOnce(d,"v42");
...
}}}}if((digitalData.page.scampaign||digitalData.page.internaldrivers||(Page.hasLeadCaptureForm()&&!digitalData.util.readCookie("v20")))&&!Page.isFormKickback()){if(digitalData.page.prevpage){digitalData.page.convertingpage=digitalData.page.prevpage;
...
}}}catch(g){}}else{if(!digitalData.util.readCookie("v20")){digitalData.page.convertingpage="Direct Landing"
}}if(digitalData.page.convertingpage){digitalData.util.writeCookie("v20",digitalData.page.convertingpage)
}}if(digitalData.util.hasEvent("formcompletesubmitbuttonclick")){if(!digitalData.util.readCookie("v22")){digitalData.page.internaldrivers="[NO INTERNAL PLACEMENT ID]"
}digitalData.util.deleteCookie("v0");
digitalData.util.deleteCookie("v20");
digitalData.util.deleteCookie("v22");
digitalData.util.deleteCookie("v28");
digitalData.util.deleteCookie("c30")
...
if(digitalData.util.readCookie("c40")||digitalData.page.drivertype){if(!digitalData.page.drivertype||(digitalData.page.drivertype===digitalData.util.readCookie("c40"))){digitalData.page.drivertype="did not bounce"
}else{if(digitalData.page.drivertype!=digitalData.util.readCookie("c40")){digitalData.page.drivertype=digitalData.util.getAndPersistValue(digitalData.page.drivertype,"c40")
...
digitalData.page.blogArticleTitle=Page.getBlogArticleTitle();
if(digitalData.page.blogpostmeta!==""&&digitalData.page.authorName!==""){digitalData.util.addBehavior("blogtagimpression")
...
}}catch(a){}if(b){digitalData.util.writeCookie("v32",digitalData.page.pagename+"|"+b)
}};
...
}}digitalData.util.trackUserBehavior=function(){var a=Page.getFeedbackButton();
if(a.length>0){a.on("click",function(){digitalData.util.addBehavior("feedbackbuttonclick")
})
}};
...
digitalData.util.trackUserBehavior();
