...
var a=function(){for(var b in CQ_Analytics.DreamforceSegmentUtils.initProperty){if(CQ_Analytics.DreamforceSegmentUtils.initProperty.hasOwnProperty(b)){CQ_Analytics.DreamforceSegmentUtils.data[b]=CQ_Analytics.DreamforceSegmentUtils.initProperty[b]
...
CQ_Analytics.DreamforceSegmentUtils.init=function(){var b="guest",e=location.href,d=CQ.shared.HTTP.getParameter(e,"forceDreamforceProfile"),c="?eventId="+$(".eventId").attr("val"),f="/wbin/dreamforce/v1/status"+c;
var g=location.hostname;
if("sfdc.local"===g||"localhost"===g){f="http://"+g+":9080"+f
}if(d){b=d;
a()
}else{$.get(f).done(function(h){CQ_Analytics.DreamforceSegmentUtils.data.visitorprofile=h.dfstatus;
CQ_Analytics.DreamforceSegmentUtils.data.eventId=h.eventId;
a()
})
}CQ_Analytics.DreamforceSegmentUtils.data={visitorprofile:b}
}
}}());
...
if(!CQ_Analytics.DemandbaseStore.data){var d=document.location.protocol,c=CQ.shared.HTTP.getParameter(document.location.href,"ipOverride"),b=d+"//api.demandbase.com/api/v2/ip.json?token=09dd7a8bed725339af3ce985f86800730b42b5cf"+((c!=""&&c!=null)?"&query="+c:"");
