...
deleteSsrCookie:function(){var a=document.location.href;if(!a)return!0;a.match(/http(s|):\/\/[^/$#?]+.rakuten.co.jp\//)?(u=!0,document.cookie="ss_r=;domain=.rakuten.co.jp;path=/;expires=Thu, 01 Jan 1970 00:00:00 GMT"):rsbmit.rslog.warn("do not delete cookie:domain is not same")},getSsrV:function(b,c){return b&&c?b+"_"+c+"_"+a.getTimeStamp():""},setSsrCookie:function(a){var f=new Date;u?(f.setMinutes(f.getMinutes()+1),document.cookie="ss_r="+a+";domain=.rakuten.co.jp;path=/;expires="+f.toUTCString()):
